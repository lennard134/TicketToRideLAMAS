...
from model.map.Connection import FerryConnection

SCREEN_WIDTH = PY_GAME_CONFIG['SCREEN_WIDTH']
SCREEN_HEIGHT = PY_GAME_CONFIG['SCREEN_HEIGHT']
CONTENT_WIDTH = PY_GAME_CONFIG['CONTENT_WIDTH']
PANEL_WIDTH = PY_GAME_CONFIG['PANEL_WIDTH']
WIDTH_BUFFER = PY_GAME_CONFIG['WIDTH_BUFFER']
HEIGHT_BUFFER = PY_GAME_CONFIG['HEIGHT_BUFFER']
BUFFER_FACTOR = PY_GAME_CONFIG['BUFFER_FACTOR']
LINE_THICKNESS = PY_GAME_CONFIG['LINE_THICKNESS']
LINE_THICKNESS_RELATION = PY_GAME_CONFIG['LINE_THICKNESS_RELATION']
...
BUTTON_HEIGHT = PY_GAME_CONFIG['BUTTON_HEIGHT']
